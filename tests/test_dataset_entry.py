...
class TestCommitTimestamp:
    ...
    def test_iso_string_parsed(self):
        e = DatasetEntry(**VALID_KWARGS, commit_timestamp_utc="2024-01-15T10:30:00+00:00")
        assert e.commit_timestamp_utc is not None
...
class TestToDict:
    ...
    def test_key_is_commit_timestamp_utc_not_private(self):
        d = DatasetEntry(**VALID_KWARGS).to_dict()
        assert "commit_timestamp_utc" in d
        assert "_commit_timestamp_utc" not in d
